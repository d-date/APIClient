...
public struct PetAPI {
     ...
     */
    public static func addPet(body: Pet) -> PostRequestBuilder {
        let path = "/pet"
    ...
    /**
     ...
     - returns: PostRequestBuilder
     */
    public static func deletePet(petId: Int64, apiKey: String? = nil) -> PostRequestBuilder {
        var path = "/pet/{petId}"
    ...
    /**
     ...
     - returns: PostRequestBuilder
     */
    public static func updatePet(body: Pet) -> PostRequestBuilder {
        let path = "/pet"
        let parameters = Parameters(
            query: nil,
            form: nil,
    ...
    /**
     ...
     - returns: PostRequestBuilder
     */
    public static func updatePetWithForm(petId: Int64, name: String? = nil, status: String? = nil) -> PostRequestBuilder {
        var path = "/pet/{petId}"
        let petIdEscaped = "\(petId)".addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{petId}", with: petIdEscaped, options: .literal, range: nil)
        let parameters = Parameters(
